...
#!------------------------------------------------------------
style.configure("TLabel", font=("Calibri", 14, "bold"), background="skyblue3")
#!------------------------------------------------------------
style.configure("TEntry", font=("Calibri", 14), background="red")
#!------------------------------------------------------------
style.configure(
    "TButton",
    font=("Arial", 14),
...
# @----------------------------------------------------------------
frame1 = tk.Frame(root, bg="skyblue1")
...
searc_frame = tk.Frame(frame1, bg="yellow")
searc_frame.place(x=438, y=217, width=110, height=50)
...
# endregion
# region  Book  LABELs        [rgba(0,0,255,0.1)]
# @----------------------------------------------------------------
# #! --------- labels ------------------------------
book_labels_text = [
    "المسلسل",
...
for i in range(0, 7):
    ...
    button.place(x=i * 111 + 220, y=222, width=100, height=40)
...
row_count_label.place(x=5, y=223, width=200, height=40)
# endregion
